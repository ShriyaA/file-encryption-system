...
import com.example.fileencryptionsystem.service.StreamingEncryptionService;
import java.io.File;
...
public class StreamingEncryptionServiceTest {
  ...
  StreamingEncryptionService streamingEncryptionService = new StreamingEncryptionService();
  ...
  public void testEncryptionDecryptionVideo_MP4() throws GeneralSecurityException, IOException {
    ...
    streamingEncryptionService.encryptFile(inputFile, key);
    ...
    streamingEncryptionService.decryptFile(encryptedFile, key);
